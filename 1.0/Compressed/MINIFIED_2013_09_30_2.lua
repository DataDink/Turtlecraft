...
cb end
ca.cone=function(ab,bb)local cb={}for z=-ab,ab do local db=1 / (ab*2)* (ab*2 -z)
for _c,ac in ipairs(bb)do table.insert(cb,{x=
ac.x*db,y=ac.y*db,z=z})end end;return cb end
