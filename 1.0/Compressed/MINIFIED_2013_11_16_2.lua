...
_a.max.x=_a.max.x+math.abs(_b)elseif(dc==b.south)then _a.min.y=_a.min.y-math.abs(ca)_a.min.x=
_a.min.x-math.abs(_b)
_a.max.x=_a.max.x+math.abs(da)elseif(dc==b.east)then _a.max.x=_a.max.x+math.abs(ca)_a.min.y=
